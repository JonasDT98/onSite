...
@section('content')
    ...
    <form>
        ...
        <div class="mb-3">
            ...
            <textarea name="description" class="form-control" id="description" cols="40" rows="4"></textarea>
        </div>
        <div class="mb-3">
            <label for="price" class="form-label">Product price</label>
            <input type="text" class="form-control" id="price" aria-describedby="namehelp">
        </div>

        <div class="mb-3">
            <label for="image" class="form-label">Product images (only jpg or png)</label>
            <input type="file" class="form-control" id="image" aria-describedby="namehelp">
        </div>
